...
const LoginForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate login - In a real app, you would connect this to your auth provider
    try {
      ...
      toast({
        ...
        description: "Welcome back to ColorWave!",
      });
  ...
  return (
    <div className="w-full space-y-6 animate-slide-up">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-xs text-custom-purple2 hover:text-custom-purple1 font-medium">
              Forgot password?
            </Link>
          </div>
          <Input
      ...
      <div className="text-center text-sm">
        ...
        <Link to="/signup" className="font-medium text-custom-purple2 hover:text-custom-purple1">
          Sign up
        </Link>
      </div>
    </div>
